        ...
        @else
            ...
            @if (Route::has('register'))
                ...
                <a href="{{ route('articles.index') }}"
                    class="bg-red-700 rounded-md py-2 px-4 font-semibold text-white hover:text-gray-900 dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Articles</a>
            @endif
        @endauth
    </div>
@endif
